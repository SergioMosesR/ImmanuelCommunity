            ...
            <div class="col-md-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Kawi No.5 / 111, Tegalsari, Kec. Candisari,
                            Kota Semarang, Jawa Tengah 50252 <br><i class="fas fa-phone"></i><a href="tel:+62676328">
                                Telp : 6716328</h5>
                        <a href="https://maps.app.goo.gl/1an4ui5bxjZgMPFy8" target="_blank" class="btn btn-primary"
                ...
                <div class="qr-section">
                    <div class="qr-item" data-info="../../assets/pop_up/k1/09 Kana Kolekte 1.jpg">
                        <img src="../../assets/kolekte1/k1-kana.jpg" alt="Kolekte 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/k2/09 Kana Kolekte 2.jpg">
                        <img src="../../assets/kolekte2/k2-kana.jpg" alt="kolekte 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/p/09 Kana perpuluhan.jpg">
                        <img src="../../assets/perpuluhan/p-kana.jpg" alt="Perpuluhan">
                        <p>Perpuluhan</p>
                    </div>
                </div>
