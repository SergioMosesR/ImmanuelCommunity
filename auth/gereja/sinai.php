        ...
        <div class="row">
            <div class="col-md-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Muradi No.52, Kalibanteng Kulon, Kec. Semarang
                            Barat, Kota Semarang, Jawa Tengah 50183 <br><i class="fas fa-phone"></i><a
                                href="tel:+627606167">Telp: 7606167 <br><i class="fa-brands fa-whatsapp"></i><a
                                    href="tel:+628995854173"> HP: 08995854173</h5>
                        <a href="https://maps.app.goo.gl/W7QJNFpen1mov1b77" target="_blank" class="btn btn-primary"
            ...
            <div class="col-md-6" style="text-align: left;">
                ...
                <div class="qr-section">
                    <div class="qr-item" data-info="../../assets/pop_up/k1/08 Sinai Kolekte 1.jpg">
                        <img src="../../assets/kolekte1/k1-sinai.jpg" alt="Kolekte 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/k2/08 Sinai Kolekte 2.jpg">
                        <img src="../../assets/kolekte2/k2-sinai.jpg" alt="kolekte 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/p/08 Sinai perpuluhan.jpg">
                        <img src="../../assets/perpuluhan/p-sinai.jpg" alt="Perpuluhan">
                        <p>Perpuluhan</p>
                    </div>
                </div>
