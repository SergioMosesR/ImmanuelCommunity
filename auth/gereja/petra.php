...
<body>
    ...
    <section class="contact-section py-5">
            ...
            <div class="col-md-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. MT. Haryono No.844-846, Karangturi, Kec.
                            Semarang Tim., Kota Semarang, Jawa Tengah 50124</h5>
                        <a href="https://maps.app.goo.gl/2pwmdW6NC2WxQSN49" target="_blank" class="btn btn-primary"
        ...
        <div class="qr-section">
            <div class="qr-item" data-info="../../assets/pop_up/k1/02 Petra Kolekte 1.jpg">
                <img src="../../assets/kolekte1/k1-petra.jpg" alt="Kolekte 1">
                <p>Kolekte 01</p>
            </div>
            <div class="qr-item" data-info="../../assets/pop_up/k2/02 Petra Kolekte 2.jpg">
                <img src="../../assets/kolekte2/k2-petra.jpg" alt="kolekte 2">
                <p>Kolekte 02</p>
            </div>
            <div class="qr-item" data-info="../../assets/pop_up/p/02 Petra perpuluhan.jpg">
                <img src="../../assets/perpuluhan/p-petra.jpg" alt="Perpuluhan">
                <p>Perpuluhan</p>
            </div>
        </div>
