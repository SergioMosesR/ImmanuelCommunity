        ...
        <div class="row">
            <div class="col-md-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Nangka Sel. No.43, Lamper Kidul, Kec. Semarang
                            Sel., Kota Semarang, Jawa Tengah 50249 <br><i class="fas fa-phone"></i><a
                                href="tel:+628443375"> Telp : 8443375 </h5>
                        <a href="https://maps.app.goo.gl/C9YiyXLEsWncM8ee8" target="_blank" class="btn btn-primary"
            ...
            <div class="col-md-6" style="text-align: left;">
                ...
                <div class="qr-section">
                    <div class="qr-item" data-info="../../assets/pop_up/k1/06 Karmel Kolekte 1.jpg">
                        <img src="../../assets/kolekte1/k1-karmel.jpg" alt="Kolekte 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/k2/06 Karmel Kolekte 2.jpg">
                        <img src="../../assets/kolekte2/k2-karmel.jpg" alt="kolekte 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/p/06 Karmel perpuluhan.jpg">
                        <img src="../../assets/perpuluhan/p-karmel.jpg" alt="Perpuluhan">
                        <p>Perpuluhan</p>
                    </div>
                </div>
