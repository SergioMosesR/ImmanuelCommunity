...
<body>
    ...
    <section class="contact-section py-5">
            ...
            <div class="col-md-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Pasirmas Raya No.143b, Panggung Lor, Kec.
                            Semarang Utara, Kota Semarang, Jawa Tengah 50177 <br> <i class="fas fa-phone"></i><a
                                href="tel:+623547809"> Telp: 3547809</h5>
                        <a href="https://maps.app.goo.gl/oH4x9CQLcpjdsKkJA" target="_blank" class="btn btn-primary"
        ...
        <div class="qr-section">
            <div class="qr-item" data-info="../../assets/pop_up/k1/03 Hermon Kolekte 1.jpg">
                <img src="../../assets/kolekte1/k1-hermon.jpg" alt="Kolekte 1">
                <p>Kolekte 01</p>
            </div>
            <div class="qr-item" data-info="../../assets/pop_up/k2/03 Hermon Kolekte 2.jpg">
                <img src="../../assets/kolekte2/k2-hermon.jpg" alt="kolekte 2">
                <p>Kolekte 02</p>
            </div>
            <div class="qr-item" data-info="../../assets/pop_up/p/03 Hermon perpuluhan.jpg">
                <img src="../../assets/perpuluhan/p-hermon.jpg" alt="Perpuluhan">
                <p>Perpuluhan</p>
            </div>
        </div>
