        ...
        <div class="row">
            <div class="col-md-6 mb-5">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Puri Anjasmoro Blk. K6 No.7 blok p, Tawangsari,
                            Semarang Barat, Semarang City, Central Java 50144 <br><i class="fas fa-phone"></i><a
                                href="tel:+627612248">Telp : 7612248</h5>
                        <a href="https://maps.app.goo.gl/9MBgkmcDXC38uSAe8" target="_blank" class="btn btn-primary"
            ...
            <div class="col-md-6" style="text-align: left;">
                ...
                <div class="qr-section">
                    <div class="qr-item" data-info="../../assets/pop_up/k1/04 Mahanaim Kolekte 1.jpg">
                        <img src="../../assets/kolekte1/k1-mahanaim.jpg" alt="Kolekte 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/k2/04 Mahanaim Kolekte 2.jpg">
                        <img src="../../assets/kolekte2/k2-mahanaim.jpg" alt="kolekte 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item" data-info="../../assets/pop_up/p/04 Mahanaim perpuluhan.jpg">
                        <img src="../../assets/perpuluhan/p-mahanaim.jpg" alt="Perpuluhan">
                        <p>Perpuluhan</p>
                    </div>
                </div>
